(function () {
  ...
  function setupDrag(el, wall) {
    ...
    function isInteractive(target) {
      while (target && target !== el) {
        ...
        if (tag === "input" || tag === "select" || tag === "textarea" || tag === "button" || tag === "label" || tag === "option" || tag === "a") {
          return true;
        }
    ...
    // bind to window so it keeps tracking even if pointer leaves the note
  ...
  function init() {
    ...
    $("breathBtn").onclick = function () {
      ...
      $("breathBtn").textContent = breathOn ? "stop" : "go";
    };
    ...
    var defaultRem = "it always feels permanent until it isnt";
    ...
    $("editReminder").onclick = function () {
      ...
      if (editing) {
        ...
        $("editReminder").textContent = "change";
      } else {
